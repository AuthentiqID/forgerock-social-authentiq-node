...
- Obtain a `client_id` and `client_secret` for your application from the [Authentiq Dashboard](https://dashboard.authentiq.com/?utm_source=github&utm_medium=readme&utm_campaign=forgerock-social-authentiq).
